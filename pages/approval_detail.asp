            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <% If usageRS("approval_status") = "반려" And usageRS("user_id") = Session("user_id") Then %>
                            <form method="post" action="card_usage_update.asp" id="updateForm">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th>사용일자</th>
                                        <td>
                                            <input type="date" name="usage_date" class="form-control" value="<%= usageRS("usage_date") %>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>사용처</th>
                                        <td>
                                            <input type="text" name="store_name" class="form-control" value="<%= usageRS("store_name") %>" required>
                                        </td>
                                        <th>금액</th>
                                        <td>
                                            <input type="text" name="amount" class="form-control" value="<%= FormatNumber(usageRS("amount"), 0) %>" required>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>사용목적</th>
