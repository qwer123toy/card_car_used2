...
<div class="card-usage-add-container">
    <div class="shadcn-card" style="max-width: 700px; margin: 30px auto;">
        ...
        <div class="form-group">
            <label class="shadcn-input-label">결재라인</label>
            <ol id="approvalList">
                <li id="step1_name">-</li>
                <li id="step2_name">-</li>
                <li id="step3_name">-</li>
            ...
            <input type="hidden" name="approver_step1" id="step1_id">
            <input type="hidden" name="approver_step2" id="step2_id">
            <input type="hidden" name="approver_step3" id="step3_id">
        
            <button type="button" class="shadcn-btn shadcn-btn-secondary" onclick="openApprovalLinePopup()">결재라인 지정</button>
        </div>
        
        <script>
        function openApprovalLinePopup() {
            window.open("approval_line_popup.asp", "approvalPopup", "width=800,height=600");
        }
        </script>
