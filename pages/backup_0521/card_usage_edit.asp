...
SQL = "SELECT u.usage_id, u.user_id, u.card_id, u.usage_date, u.amount, u.store_name, " & _
      "u.purpose, u.approval_status, u.department_id, u.expense_category_id " & _
...
If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
    Dim cardId, usageDate, amount, purpose, expenseCategoryId, storeName
    ...
    ' 입력값 검증
    If cardId = "" Or usageDate = "" Or amount = "" Or expenseCategoryId = "" Or storeName = "" Then
    ...
    Else
        ...
        cmd.CommandText = "UPDATE " & dbSchema & ".CardUsage SET card_id = ?, usage_date = ?, amount = ?, " & _
                         "expense_category_id = ?, store_name = ?, purpose = ? " & _
                         "WHERE usage_id = ?"
