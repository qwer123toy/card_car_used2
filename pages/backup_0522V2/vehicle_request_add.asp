...
If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
    Dim startDate, endDate, purpose, startLocation, destination, distance, tollFee, parkingFee, totalAmount, errorMsg, successMsg, title
    ...
    Else
        ...
        cmd.CommandText = "INSERT INTO VehicleRequests (user_id, start_date, end_date, purpose, start_location, destination, " & _
                         "distance, toll_fee, parking_fee, title, approval_status, is_deleted) " & _
                         "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
        ...
        <div class="shadcn-card-content">
            <form id="vehicleRequestForm" method="post" action="vehicle_request_add.asp" onsubmit="prepareFormSubmission(); return validateForm('vehicleRequestForm', vehicleRequestRules)">
                ...
                <div class="form-group">
                    ...
                    <input class="shadcn-input" type="text" id="title" name="title" placeholder="결재 제목을 입력하세요">
                </div>
