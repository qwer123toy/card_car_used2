...
If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
    ...
    ' 입력값 검증
    If cardId = "" Or usageDate = "" Or amount = "" Or accountTypeId = "" Or storeName = "" Or title = "" Or approver1 = "" Then
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form method="post" action="card_usage_add.asp" id="cardUsageForm">
                ...
                <div class="form-group">
                    <label for="title">제목<span class="required-mark">*</span></label>
                    <input type="text" class="form-control" id="title" name="title" placeholder="결재 제목을 입력하세요" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="amount" name="amount" required pattern="^\d{1,3}(,\d{3})*$" inputmode="numeric" onkeyup="cleanNumberInput(this);">
