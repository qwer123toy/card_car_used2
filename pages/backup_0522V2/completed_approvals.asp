                                ...
                                <tr>
                                    ...
                                    <td>
                                        <% If rs("doc_type") = "CardUsage" Then %>
                                            <span class="badge badge-primary">카드</span>
                                        <% ElseIf rs("doc_type") = "VehicleRequests" Then %>
                                            <span class="badge badge-info">차량</span>
                                        <% End If %>
                                    </td>
                                    <td><%= rs("title") %></td>
                                    <td><%= rs("store_name") %></td>
                                    ...
                                    <td>
                                        <a href="approval_detail.asp?id=<%= rs("doc_id") %>&type=<%= rs("doc_type") %>" class="btn btn-sm btn-outline-primary">상세보기</a>
                                    </td>
                                </tr>
                            <%
                                rs.MoveNext
