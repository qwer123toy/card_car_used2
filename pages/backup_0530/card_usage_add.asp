...
If Request.ServerVariables("REQUEST_METHOD") = "POST" Then
    Dim cardId, usageDate, amount, purpose, accountTypeId, storeName, title, costTypeId 
    ...
    ' 입력값 검증
    If cardId = "" Or usageDate = "" Or amount = "" Or accountTypeId = "" Or storeName = "" Or title = "" Or costTypeId = "" Then
    ...
    Else
        ...
        cmd.CommandText = "INSERT INTO " & dbSchema & ".CardUsage (user_id, card_id, usage_date, amount, expense_category_id,cost_type_id, department_id, store_name, purpose, title, approval_status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
                ...
                <div class="approval-line-table-container" style="margin-top: 1rem;">
                    <table class="approval-line-table">
                        <tbody>
                            ...
                            <tr>
                                <td class="approval-cell" style="background: #F8FAFC; font-weight: 600;">판관/제조 <span style="color: #E74C3C;">*</span></td>
                                <td class="approval-cell" colspan="4" style="text-align: left; padding: 1rem;">
                                    <select class="form-control" id="cost_type_id" name="cost_type_id" required style="border: 1px solid #E9ECEF; width: 100%;">
                                        <option value="">판관/제조 선택</option>
                                        <% 
                                        If Not costTypeRS.EOF Then
                                            Do While Not costTypeRS.EOF 
                                        %>
                                            <option value="<%= costTypeRS("cost_type_id") %>"><%= costTypeRS("type_name") %></option>
                                        <% 
                                            costTypeRS.MoveNext
                                            Loop
                                        End If
