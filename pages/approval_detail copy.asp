...
<div class="container">
    ...
    <% End If %>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="card-title mb-0">결재선 및 기본정보</h5>
            </div>
            <div class="card-body">
                <div class="approval-line-table-container">
                    <table class="approval-line-table">
                        <tbody>
                            ...
                            <% If isCardUsage Then %>
                                ...
                                <form method="post" action="card_usage_update.asp" id="updateForm">
                                    ...
                                    <tr>
                                        <td class="approval-cell" style="background: #F8FAFC; font-weight: 600;">신청자</td>
                                    ...
                                    <tr>
                                        <td class="approval-cell" style="background: #F8FAFC; font-weight: 600;">제목</td>
                                        <td class="approval-cell" colspan="4" style="padding: 0;">
                            ...
                            <% ElseIf isVehicleRequest Then %>
                                ...
                                <form method="post" action="vehicle_request_update.asp" id="updateForm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="approval-cell">
                                            <% If usageRS("user_id") = Session("user_id") And (usageRS("approval_status") = "대기" Or usageRS("approval_status") = "반려") Then %>
                                                ...
                                                End If
                                                %>
                                                <input type="date" name="start_date" class="form-control"  style="width: 96%; border-radius: 0;" value="<%= startDateValue %>" required style="font-size: 0.85rem;">
                                            <% Else %>
                                                <% 
                                                startDate = VehicleSafeField(usageRS, "start_date")
                                                If startDate <> "" Then
                                        ...
                                        <td class="approval-cell">
                                            <% If usageRS("user_id") = Session("user_id") And (usageRS("approval_status") = "대기" Or usageRS("approval_status") = "반려") Then %>
                                                ...
                                                End If
                                                %>
                                                <input type="date" name="end_date" class="form-control"  style="width: 96%; border-radius: 0;" value="<%= endDateValue %>" required style="font-size: 0.85rem;">
                                            <% Else %>
                                                <% 
                                                endDate = VehicleSafeField(usageRS, "end_date")
                                                If endDate <> "" Then
                                    ...
                                    <tr>
                                        ...
                                        <td class="approval-cell">
                                            <% If usageRS("user_id") = Session("user_id") And (usageRS("approval_status") = "대기" Or usageRS("approval_status") = "반려") Then %>
                                                <input type="text" name="start_location" class="form-control"  style="width: 96%; border-radius: 0;" value="<%= VehicleSafeField(usageRS, "start_location") %>" required style="font-size: 0.85rem;">
                                            <% Else %>
                                        ...
                                        <td class="approval-cell">
                                            <% If usageRS("user_id") = Session("user_id") And (usageRS("approval_status") = "대기" Or usageRS("approval_status") = "반려") Then %>
                                                <input type="text" name="destination" class="form-control"  style="width: 96%; border-radius: 0;" value="<%= VehicleSafeField(usageRS, "destination") %>" required style="font-size: 0.85rem;">
                                            <% Else %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="approval-cell">
                                            <% If usageRS("user_id") = Session("user_id") And (usageRS("approval_status") = "대기" Or usageRS("approval_status") = "반려") Then %>
                                                <div class="input-group" style="font-size: 0.85rem;">
                                                    <input type="text" name="distance" class="form-control text-end"  style="width: 80%; border-radius: 0;" value="<%= distance %>" required style="font-size: 0.85rem;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="approval-cell">
                                            <% If usageRS("user_id") = Session("user_id") And (usageRS("approval_status") = "대기" Or usageRS("approval_status") = "반려") Then %>
                                                <div class="input-group" style="font-size: 0.85rem;">
                                                    <input type="text" name="toll_fee" class="form-control text-end"  style="width: 80%; border-radius: 0;" value="<%= FormatNumber(tollFee) %>" style="font-size: 0.85rem;">
                                                    <span class="input-group-text" style="font-size: 0.85rem;">원</span>
                                                </div>
                                            <% Else %>
                                        ...
                                        <td class="approval-cell">
                                            <% If usageRS("user_id") = Session("user_id") And (usageRS("approval_status") = "대기" Or usageRS("approval_status") = "반려") Then %>
                                                <div class="input-group" style="font-size: 0.85rem;">
                                                    <input type="text" name="parking_fee" class="form-control text-end" style="width: 80%; border-radius: 0;"  value="<%= FormatNumber(parkingFee) %>" style="font-size: 0.85rem;">
                                                    <span class="input-group-text" style="font-size: 0.85rem;">원</span>
                                                </div>
                                            <% Else %>
