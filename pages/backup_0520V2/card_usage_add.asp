...
<div class="container">
    <div class="page-header">
        <h2 class="page-title">카드 사용 내역 등록</h2>
    ...
    <form method="post" action="card_usage_add.asp" id="cardUsageForm">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">카드 사용 정보</h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="card_id">카드 선택<span class="text-danger">*</span></label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="usage_date">사용일자<span class="text-danger">*</span></label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="store_name">사용처<span class="text-danger">*</span></label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <div class="input-group">
                                <input type="text" class="form-control text-end" id="amount" name="amount" required>
                    ...
                    <div class="col-12">
                        <div class="form-floating">
                            ...
                            <label for="account_type_id">계정과목<span class="text-danger">*</span></label>
                        </div>
                    </div>

                    <div class="col-12">
                        <div class="form-floating">
                            <textarea class="form-control" id="purpose" name="purpose" style="height: 100px" required></textarea>
                            <label for="purpose">사용 목적<span class="text-danger">*</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="card_usage.asp" class="btn btn-secondary">
